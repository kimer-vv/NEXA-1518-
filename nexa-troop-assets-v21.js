/* NEXA V28 — TIER-SPECIFIC TROOP ART + consolidated stability loader */
...
(()=>{
 'use strict';
 if(window.__NEXA_V28_LOADER__)return;window.__NEXA_V28_LOADER__=true;
 const load=()=>{
   if(document.querySelector('script[data-nexa-v28-polish]'))return;
   const s=document.createElement('script');s.src='/nexa-v28-admin-polish.js?v=28';s.defer=true;s.dataset.nexaV28Polish='1';document.head.appendChild(s);
 };
