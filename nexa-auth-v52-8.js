(() => {
'use strict';
// NEXA V52.8 — POLISHED CINEMATIC WELCOME
...
function styles(){
  ...
  .nexa-astronaut-wrap{position:absolute;right:30vw;top:24vh;width:min(34vw,440px);min-width:235px;animation:nexaFloat 7.2s ease-in-out infinite;transform-origin:65% 45%;filter:drop-shadow(0 22px 30px rgba(0,0,0,.38))}
    ...
    <div class="nexa-astronaut-wrap" aria-hidden="true">
      <svg class="nexa-astronaut-svg" viewBox="0 0 520 420" role="img">
        ...
        <g transform="translate(40 55)">
          ...
          <ellipse cx="184" cy="89" rx="69" ry="73" fill="#e8eefc" stroke="#7f8cad" stroke-width="4"/>
          <ellipse cx="186" cy="92" rx="56" ry="45" fill="url(#visorG)" stroke="#56658c" stroke-width="3"/>
