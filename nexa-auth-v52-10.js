(() => {
'use strict';
// NEXA V52.10 — DRAMATIC ASTRONAUT REDESIGN
...
function buildWelcome(){
  ...
  <g transform="translate(5 5) rotate(-10 320 250)">
    ...
    <g class="nexa-astronaut-hand">
      ...
      <path d="M468 86 Q492 72 517 59"
            fill="none" stroke="#eaf0fb" stroke-width="19" stroke-linecap="round"/>
      <ellipse cx="522" cy="57" rx="11" ry="13"
               fill="#edf3fd" transform="rotate(-22 522 57)"/>
      <path d="M525 53 L550 42" stroke="#edf3fd" stroke-width="5.8" stroke-linecap="round"/>
      <path d="M526 57 L553 53" stroke="#edf3fd" stroke-width="5.2" stroke-linecap="round"/>
      <path d="M525 62 L550 65" stroke="#edf3fd" stroke-width="5.2" stroke-linecap="round"/>
    </g>
    ...
    <!-- fingertip energy -->
    <circle class="nexa-touch-glow" cx="563" cy="36" r="42" fill="url(#glow10)"/>
  </g>
</svg>
    </div>
