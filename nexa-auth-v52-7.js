(() => {
'use strict';
// NEXA V52.7 — CINEMATIC FIRST-WELCOME INTRO
...
function styles(){
  ...
  .nexa-astronaut-wrap{position:absolute;right:30vw;top:24vh;width:min(34vw,440px);min-width:235px;animation:nexaFloat 5.4s ease-in-out infinite;transform-origin:65% 45%;filter:drop-shadow(0 22px 30px rgba(0,0,0,.38))}
  ...
  .nexa-astronaut-hand{animation:nexaReach 4.7s ease-in-out infinite;transform-origin:78% 47%}
  ...
  .nexa-welcome-kicker{font-size:11px;letter-spacing:.32em;color:#9099c2;font-weight:800;margin-bottom:12px}
  .nexa-welcome-copy h1{margin:0;font-size:clamp(42px,6vw,82px);line-height:.94;letter-spacing:.055em;text-shadow:0 0 32px rgba(108,88,255,.22)}
  .nexa-welcome-copy h2{margin:16px 0 0;font-size:clamp(18px,2.2vw,29px);font-weight:700;color:#ccd2eb}
  .nexa-welcome-copy p{margin:10px 0 24px;color:#8f9abd;font-size:14px;letter-spacing:.03em}
  .nexa-enter-btn{border:1px solid rgba(152,132,255,.5);border-radius:14px;padding:13px 19px;background:linear-gradient(135deg,rgba(116,64,255,.92),rgba(27,139,255,.86));color:#fff;font-weight:900;letter-spacing:.08em;box-shadow:0 14px 38px rgba(62,74,255,.18);cursor:pointer}
  .nexa-skip-btn{margin-left:10px;border:0;background:transparent;color:#7883a6;font-weight:700;cursor:pointer}
  ...
  @media(max-width:760px){
    ...
    .nexa-astronaut-wrap{right:21vw;top:12vh;width:58vw;min-width:230px}
...
function buildWelcome(){
  ...
  scene.innerHTML=`
    ...
    <div class="nexa-astronaut-wrap" aria-hidden="true">
      <svg class="nexa-astronaut-svg" viewBox="0 0 520 420" role="img">
        <defs>
          <linearGradient id="suitG" x1="0" x2="1"><stop offset="0" stop-color="#cdd6ee"/><stop offset=".55" stop-color="#f7f9ff"/><stop offset="1" stop-color="#aab7d8"/></linearGradient>
          <linearGradient id="visorG" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#17213f"/><stop offset=".55" stop-color="#344b82"/><stop offset="1" stop-color="#8ea9ff"/></linearGradient>
          <radialGradient id="touchG"><stop stop-color="#fff"/><stop offset=".35" stop-color="#a9c8ff"/><stop offset="1" stop-color="#7a5bff" stop-opacity="0"/></radialGradient>
        </defs>
        <g transform="translate(40 55)">
          <ellipse cx="205" cy="342" rx="112" ry="18" fill="rgba(0,0,0,.18)"/>
          <rect x="95" y="119" width="178" height="179" rx="74" fill="url(#suitG)" stroke="#7f8bac" stroke-width="3"/>
          <rect x="117" y="168" width="137" height="76" rx="19" fill="#e8edfa" stroke="#9aa7c9" stroke-width="2"/>
          <rect x="143" y="187" width="83" height="34" rx="8" fill="#2b3557"/>
          <circle cx="158" cy="204" r="5" fill="#53e0c3"/><circle cx="174" cy="204" r="5" fill="#8f7dff"/><rect x="188" y="198" width="25" height="11" rx="5" fill="#677498"/>
          <circle cx="184" cy="87" r="76" fill="#eef2ff" stroke="#8794b8" stroke-width="4"/>
          <ellipse cx="186" cy="91" rx="58" ry="48" fill="url(#visorG)" stroke="#6e7da7" stroke-width="3"/>
          <path d="M153 73 C177 49 213 48 238 69" fill="none" stroke="rgba(255,255,255,.28)" stroke-width="7" stroke-linecap="round"/>
          <g class="nexa-astronaut-hand">
            <path d="M262 168 C310 148 340 126 379 98" fill="none" stroke="url(#suitG)" stroke-width="38" stroke-linecap="round"/>
            <path d="M370 102 C393 90 414 78 438 65" fill="none" stroke="#eef2ff" stroke-width="24" stroke-linecap="round"/>
            <circle cx="442" cy="63" r="13" fill="#edf2ff"/>
            <path d="M439 59 L470 49" stroke="#edf2ff" stroke-width="8" stroke-linecap="round"/>
            <path d="M440 64 L471 64" stroke="#edf2ff" stroke-width="7" stroke-linecap="round"/>
            <path d="M438 69 L467 78" stroke="#edf2ff" stroke-width="7" stroke-linecap="round"/>
          </g>
          <path d="M111 170 C76 205 64 238 63 284" fill="none" stroke="url(#suitG)" stroke-width="38" stroke-linecap="round"/>
          <path d="M137 289 C123 329 115 349 104 371" stroke="url(#suitG)" stroke-width="41" stroke-linecap="round"/>
          <path d="M229 291 C246 326 257 347 270 371" stroke="url(#suitG)" stroke-width="41" stroke-linecap="round"/>
          <rect x="76" y="148" width="39" height="104" rx="17" fill="#98a6ca" opacity=".95"/>
          <circle class="nexa-touch-glow" cx="483" cy="47" r="34" fill="url(#touchG)"/>
        </g>
      </svg>
    </div>
    <div class="nexa-welcome-copy">
      ...
      <button id="nexa-skip-btn" class="nexa-skip-btn" type="button">Skip intro</button>
    </div>`;
  ...
  document.getElementById('nexa-skip-btn').addEventListener('click',completeWelcome);
}
...
function showWelcome(name=''){
  ...
  title.textContent=clean ? `WELCOME TO NEXA, ${clean.toUpperCase()}` : 'WELCOME TO NEXA';
  hide();
